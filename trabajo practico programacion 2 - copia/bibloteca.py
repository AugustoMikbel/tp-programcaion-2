...
def ejemplares_prestados():
    ...
    for i in libros:
        if i['cant_ej_pr']>0:
            print("El titulo del libro es de: ", i['titulo'])
            print("La cantidad e ejemplares prestaados es de: ",i['cant_ej_pr'])
            print("El nombre del autor es: ",i['autor'])
        else:    
            print("Este libro no tiene libros prestados: ",i['titulo'])
